# Excel Utils V2 - Usage Guide

## Overview

ExcelServiceV2 is an improved version of the Excel export library with better performance, type safety, and configurability.
...
```java
import com.excelutils.ExcelServiceV2;
...
public class OrderDto {
    ...
    @ExcelField(name = "Amount", order = 3,
                converter = SafeExcelBigDecimalConverter.class)
...
ExcelServiceV2 service = new ExcelServiceV2();
...
ExcelServiceV2 service = new ExcelServiceV2(config);
byte[] excelBytes = service.exportToExcel(orders);
```
...
public class UserDto {
    ...
    @ExcelField(name = "فعال", order = 3,
               converter = SafeExcelBooleanConverter.class)
    private Boolean active;

    @ExcelField(name = "تاریخ ثبت", order = 4,
               converter = SafeExcelTimeToJalaliConverter.class)
...
### SafeExcelTimeToJalaliConverter
